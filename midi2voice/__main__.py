...
ap.add_argument("-lang", "--language", required=False, default="english", choices=['english', 'japanese', 'mandarin', 'korean'],
   help="Language of the voice (english/japanese/mandarin/korean)")
